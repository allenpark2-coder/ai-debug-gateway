...
Implemented and verified the common deny-by-default shell policy classifier. No Felix or vendor-specific allow rules were added.
...
- No Felix, `opsis-*`, or vendor command rules exist.
