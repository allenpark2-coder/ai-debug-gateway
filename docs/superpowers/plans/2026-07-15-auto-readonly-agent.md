...
- Unknown syntax, executables, subcommands, options, paths, vendor tools, and Felix tools are denied automatically.
...
- No untested Felix rules ship in this release.
